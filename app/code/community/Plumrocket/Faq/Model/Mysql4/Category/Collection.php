...
class Plumrocket_Faq_Model_Mysql4_Category_Collection extends Mage_Core_Model_Mysql4_Collection_Abstract
{
    ...
    public function addStoreFilter($store)
    {
        ...
        $this->getSelect()->join(
            array('store_table' => $this->getTable('plumrocket_faq/category_store')),
        ...
        if ($this->_previewFlag) {
            ...
            if (count($items)) {
                $select = $this->getConnection()->select()->from(
                    ...
                    $this->getTable('plumrocket_faq/category_store') . '.category_id IN (?)',
                    $items
                );
